...
public class ModCreativeTabs {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
        DeferredRegister.create(Registries.CREATIVE_MODE_TAB, "dragonblockinfinity");
    ...
    public static final RegistryObject<CreativeModeTab> DRAGON_BLOCK_TAB =
        ...
        output.accept(new ItemStack(ModItems.SENZU.get()));
        output.accept(new ItemStack(ModItems.DINO_MEAT_COOKED.get()));
        output.accept(new ItemStack(ModItems.DINO_MEAT.get()));
    })
                .build());
